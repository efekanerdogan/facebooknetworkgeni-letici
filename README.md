...
bookmarklet_kurulum.html dosyasını tarayıcınızda (Chrome, Edge, Safari vb.) açın.
Ekranda gördüğünüz mavi "🦊 FB Network Genişletici" hap (pill) butonuna farenizle basılı tutun.
Fareyi bırakmadan tarayıcınızın Yer İmleri Çubuğuna (Bookmarks Bar) sürükleyip bırakın.
...
🎮 Nasıl Kullanılır?
Facebook'a Girin: Facebook hesabınıza giriş yapın.
Hedef Belirleyin: Arkadaş eklemek istediğiniz Önerilen Arkadaşlar, Grup Üyeleri veya Herhangi bir sayfa listesine gidin.
Aracı Çalıştırın: Tarayıcınızın yer imleri çubuğuna kaydettiğiniz "🦊 FB Network Genişletici" butonuna tıklayın.
Ayarları Yapın: Ekranda beliren şık panelden:
...
Ateşleyin: "🚀 Sistemi Başlat" butonuna tıklayın ve bırakın sistem sizin için tüm işlemleri yapsın! İşlem bitene kadar o sekmeyi açık tutmanız yeterlidir.
